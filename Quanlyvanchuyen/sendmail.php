...
if(isset($_POST['email'])) {
    ...
    $email_message = " Cảm ơn bạn đã đặt xe ở bến xe B.K.H\n\n";
            ...
            <div class="col-md-6">
               <br><br><br><br><br>
                <div class="alert alert-success animated tada">
                      <strong>Hoàn thành</strong> Xác nhận thành công đơn!.
                </div>
                
                <a class="btn btn-default" href="admin_dondatxe.php">Trở lại</a>
            </div>
            <div class="col-md-3"></div>
        </div>
    </div>
