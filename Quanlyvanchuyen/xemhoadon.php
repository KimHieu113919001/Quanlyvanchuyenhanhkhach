    ...
    <div class="container">
        ...
        <br><br>
           ...
           <a class="btn btn-info nut" href="admin_datxe.php">Quay lại</a>
            <h1 style="text-align: center;">Thông tin đơn đặt xe</h1>
        ...
        <table class="table" >
          ...
          <tr>
            ...
            <td style="color:#000000;font-weight:bold;"><?php echo $row['tenkhachhang']; ?></td>
          </tr>
          <tr>
            <th >Số điện thoại:</th>
            <td style="color:#000000;font-weight:bold;"><?php echo $row['sodienthoai']; ?></td>
          </tr>
        ...
        <tr>
            ...
            <td style="color:#000000;font-weight:bold;"><?php echo $row['hinhthuc']; ?></td>
      </tr>
        <tr>
            <th >Tiền đặt xe:</th>
            <td style="color:#000000; font-weight:bold;"><?php echo number_format($row['giavexe']); ?> VNĐ</td>
        </tr>
        
        </table>  
        <div style="text-align:center;">
        <a  class="btn btn-success nut" href="xacnhandon.php?id=<?php echo $row['bookingyc_id']; ?>">Xác nhận</a>
      </div>
        </div>
      </div>
    </div>
